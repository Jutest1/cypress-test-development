...
allure.story("PCM- 2.151 |  Update Plant from item in contract module");
describe("PCM- 2.151 |  Update Plant from item in contract module", () => {

    before(function () {
        cy.fixture("pcm/pcm-2.151-update-plant-from-item-in-contract-module.json").then((data) => {
            this.data = data;
            ...
            PLANT_PARAMETERS = {
                ...
                [commonLocators.CommonLabels.PLANT]: CONTAINERS_PLANTS.PLANT,
    ...
    it('TC - Verify update plant from contract wizard option', function () {
        _common.openTab(app.TabBar.CONTRACT).then(() => {
