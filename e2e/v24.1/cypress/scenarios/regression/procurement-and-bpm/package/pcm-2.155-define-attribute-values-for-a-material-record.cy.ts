...
ALLURE.story("PCM- 2.155 | Define Attribute values for a material record")
describe("PCM- 2.155 | Define Attribute values for a material record", () => {

    before(function () {

        cy.fixture("pcm/pcm-2.155-define-attribute-values-for-a-material-record.json").then((data) => {
            this.data = data
