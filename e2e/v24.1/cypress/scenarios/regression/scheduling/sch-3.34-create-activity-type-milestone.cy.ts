...
ALLURE.story("SCH- 3.34 | Create Milestone Activity ");

describe("SCH- 3.34 | Create Milestone Activity ", () => {
    before(function () {   
        cy.fixture("scheduling/sch-3.34-create-activity-type-milestone.json").then((data) => {
            this.data = data
