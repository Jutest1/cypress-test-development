...
ALLURE.story("SCH- 3.62 | calculate-Productivity-of-activity-using-wizard-selecting-option-All the check box` ");

describe("SCH- 3.62 | calculate-Productivity-of-activity-using-wizard-selecting-option-All the check box ", () => {
    before(function () {
        cy.fixture("scheduling/sch-3.62-calculate-Productivity-of-activity-using-wizard-selecting-option-All-the-check-box.json").then((data) => {
        this.data = data
    ...
    it("TC -  Set performance %  and click All the check box an", function () {
