...
import { _common, _projectPage, _estimatePage, _mainView, _modalView, _schedulePage } from "cypress/pages";
...
ALLURE.story("EST- 2.8 | Generate line item from scheduling");

describe("EST- 2.8 | Generate line item from scheduling", () => {

  before(function () {

    cy.fixture("estimate/est-2.8-Generate-Line-item-from-Scheduling.json")
      .then((data) => {
        this.data = data;
        SCH_PARAMETERS={
  ...
  it("TC - Generate scheduling line item and verify aq quantity", function () {
