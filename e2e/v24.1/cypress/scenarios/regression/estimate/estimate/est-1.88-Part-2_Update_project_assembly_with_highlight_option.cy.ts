...
allure.story("EST- 1.88 | Part-2 Update project assembly with highlighted assembly option ")

describe('EST- 1.88 | Part-2 Update project assembly with highlighted assembly option', () => {
    before(function () {
