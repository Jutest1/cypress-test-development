...
const PROJECT_NO = "09" + Cypress._.random(0, 999);
...
allure.story("EST- 4.26 | Verify CO2 attrubutes for a newly added material from requisition to estimate")

describe("EST- 4.26 | Verify CO2 attrubutes for a newly added material from requisition to estimate", () => {

    beforeEach(function () {
        cy.fixture("estimate/est-4.26-verify-co2-attributes-for-a-newly-added-material-from-requisition-to-estimate.json").then((data) => {
            this.data = data
        })
    })
    ...
    it('TC - Create a Material Package and Requisition, add item having CO2 attribute, and Update Estimate using wizard.', function () {
