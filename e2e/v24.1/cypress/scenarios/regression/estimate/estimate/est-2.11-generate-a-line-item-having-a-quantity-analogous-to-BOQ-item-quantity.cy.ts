...
ALLURE.story('EST- 2.11 | Generate a line item having a quantity analogous to BOQ item quantity');

describe('EST- 2.11 | Generate a line item having a quantity analogous to BOQ item quantity', () => {
	before(function () {
		cy.fixture('estimate/est-2.11-generate-a-line-item-having-a-quantity-analogous-to-BOQ-item-quantity.json')
		  .then((data) => {
			this.data = data;
	...
	it('TC - Verify aq quantity analogous to BOQ item quantity', function () {
