import { _common, _estimatePage, _validate,  _modalView, _assembliesPage, _projectPage } from "cypress/pages";
    ...
    allure.story("EST- 1.90 | Part-1 Update project assembly with entire assembly option ")

    describe('EST- 1.90 | Part-1 Update project assembly with entire assembly option', () => {
        before(function () {
