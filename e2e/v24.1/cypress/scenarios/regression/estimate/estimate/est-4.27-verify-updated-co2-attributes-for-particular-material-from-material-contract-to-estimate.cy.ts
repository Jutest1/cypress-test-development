...
const CO2_VALUE1 = Cypress._.random(0, 99) + ".000";
...
allure.story("EST- 4.27 | Verify updated CO2 attributes for a particular material from material contract to estimate")
describe("EST- 4.27 | Verify updated CO2 attributes for a particular material from material contract to estimate", () => {
    before(function () {
        cy.preLoading(
        ...
        cy.fixture("estimate/est-4.27-verify-updated-co2-attributes-for-particular-material-from-material-contract-to-estimate.json").then((data) => {
            this.data = data
    ...
    it('TC - Assign material resource to the line item', function () {
        _common.openTab(app.TabBar.ESTIMATELINEITEM).then(() => {
    ...
    it("TC- Verify Create/update material package and change package status", function () {
        _common.toggleSidebar(sidebar.sideBarList.SIDEBAR_NEW_WIZARD);
        _common.search_fromSidebar(commonLocators.CommonKeys.WIZARD, sidebar.SideBarOptions.CREATE_UPDATE_MATERIAL_PACKAGE)
        _package.enterRecord_toCreatePackage_wizard(MODAL_PACKAGE.CRITERIA_SELECTION)
    ...
    it("TC- Create Contract and change Co2 attribute value", function () {
        _common.toggleSidebar(sidebar.sideBarList.SIDEBAR_NEW_WIZARD);
        ...
        _common.enterRecord_inNewRow(cnt.uuid.ITEMSCONTRACT, app.GridCells.CO2_PROJECT, app.InputFields.INPUT_GROUP_CONTENT, CO2_VALUE1)
        cy.SAVE()
        _common.waitForLoaderToDisappear()
        _common.toggleSidebar(sidebar.sideBarList.SIDEBAR_NEW_WIZARD);
    ...
    it("TC- Verify Co2 attribute in Line item", function () {
        _common.toggleSidebar(sidebar.sideBarList.SIDEBAR_QUICKSTART)
        ...
        _common.assert_forNumericValues(cnt.uuid.RESOURCES, app.GridCells.CO2_PROJECT, CO2_VALUE1)
    })
    after(() => {
        cy.LOGOUT();
    });
