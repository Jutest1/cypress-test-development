...
ALLURE.story("EST- 7.16 | Verify adding short key as R in the resources and applying simple mathematical formula in the resources");

describe("EST- 7.16 | Verify adding short key as R in the resources and applying simple mathematical formula in the resources", () => {

    
    before(function () {
        
        cy.fixture("estimate/est-7.16-verify-adding-short-key-as-R-in-the-resources-and-applying-simple-mathematical-formula-in-the-resources.json").then((data) => {
            this.data = data;
