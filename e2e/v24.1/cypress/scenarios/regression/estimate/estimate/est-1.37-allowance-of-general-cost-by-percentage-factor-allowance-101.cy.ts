...
allure.story('EST- 1.37 | allowance-of-general-cost-by-percentage-factor-allowance-101');

describe('EST- 1.37 | allowance-of-general-cost-by-percentage-factor-allowance-101', () => {
    before(function () {
        cy.fixture('estimate/est-1.37-allowance-of-general-cost-by-percentage-factor-allowance-101.json')
            .then((data) => {
                this.data = data
