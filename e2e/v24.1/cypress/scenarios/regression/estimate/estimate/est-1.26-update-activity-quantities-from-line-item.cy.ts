...
import { _common, _estimatePage, _validate, _mainView, _boqPage, _bidPage, _saleContractPage, _modalView, _salesPage, _wipPage, _package, _schedulePage } from "cypress/pages";
...
ALLURE.story("EST- 1.26 | Update activity quantities from line item")

describe("EST- 1.26 | Update activity quantities from line item", () => {

    before(function () {
        cy.fixture("estimate/est-1.26-update-activity-quantities-from-line-item.json")
          .then((data) => {
            this.data = data
            SCH_PARAMETERS={
    ...
    it('TC - Update Scheduling quantities from line item', function () {
