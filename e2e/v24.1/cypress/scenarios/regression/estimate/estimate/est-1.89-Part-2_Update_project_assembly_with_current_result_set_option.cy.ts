...
allure.epic("ESTIMATE");
    ...
    allure.story("EST- 1.89 | Part-2 Update project assembly with current result set option ")
    
    describe('EST- 1.89 | Part-2 Update project assembly with current result set option', () => {
            before(function () {
