...
allure.story("EST- 1.51 | Verify Job Estimate And AQ Quantity Relation");

describe('EST- 1.51 | Verify Job Estimate And AQ Quantity Relation', () => {
		before(function () {
			cy.fixture('estimate/est-1.51-verify-job-estimate-and-AQ-quantity-relation.json')
			  .then((data) => {
				this.data=data
    ...
    it("TC - Verify quantity total of line item", function () {
        ...
        _validate.verify_QuantityTotalOfLineItem(cnt.uuid.ESTIMATE_LINEITEMS, app.GridCells.QUANTITY_SMALL, app.GridCells.QUANTITY_TARGET, app.GridCells.QUANTITY_TOTAL)
