...
ALLURE.story("EST- 7.17 | Verify adding short key as R in the resources and applying addition of two resources using curly bracket");

describe("EST- 7.17 | Verify adding short key as R in the resources and applying addition of two resources using curly bracket", () => {

    
    before(function () {
        
        
        cy.fixture("estimate/est-7.17-verify-adding-short-key-as-R-in-the-resources-and-applying-addition-of-two-resources-using-curly-bracket.json").then((data) => {
            this.data = data;
    ...
    it("TC - Verify creating resource as a computational line (R) by using addition", function () {
        _common.waitForLoaderToDisappear()
        _common.openTab(app.TabBar.ESTIMATELINEITEM).then(() => {
