...
describe('EST- 1.22 | Update BOQ quantities from line item', () => {
	...
	before(function () {
		cy.fixture('estimate/est-1.22-update-BOQ-quantities-from-line-item.json')
		  .then((data) => {
			this.data = data;
	...
	it('TC - Verify updated quantity of BoQ structure - to structure AQ', function () {
		...
		_common.assert_forNumericValues(cnt.uuid.BOQ_STRUCTURES,app.GridCells.QUANTITY_SMALL,CONTAINERS_LINE_ITEM.WQ_QUANTITY)
