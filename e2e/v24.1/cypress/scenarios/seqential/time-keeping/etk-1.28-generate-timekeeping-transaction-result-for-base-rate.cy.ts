...
ALLURE.story("ETK- 1.28 | Generate timekeeping transaction result for base rate TK-TR001");

describe("ETK- 1.28 | Generate timekeeping transaction result for base rate TK-TR001", () => {

    before(function () {
        cy.fixture("time-keeping/etk-1.28-generate-timekeeping-transaction-result-for-base-rate.json").then((data) => {
            this.data = data;
