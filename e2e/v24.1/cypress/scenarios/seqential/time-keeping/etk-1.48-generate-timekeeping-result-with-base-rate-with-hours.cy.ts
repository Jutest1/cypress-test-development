...
ALLURE.story("ETK- 1.48 | Generate timekeeping transaction result for base rate with hours TK-TR0023");

describe("ETK- 1.48 | Generate timekeeping transaction result for base rate with hours TK-TR0023", () => {

    before(function () {
        cy.fixture("time-keeping/etk-1.48-generate-timekeeping-result-with-base-rate-with-hours.json").then((data) => {
            this.data = data;
