...
const PRJ_NO = "PRJ-TK-" + Cypress._.random(0, 999)
const PRJ_NAME = "PRJ-TK-" + Cypress._.random(0, 999)
...
const ACTIONS_CODE = 'ACTC-' + Cypress._.random(0, 999);
const ACTIONS_DESC = 'ACTD-' + Cypress._.random(0, 999);
const ACTION_TY='ACTY-' + Cypress._.random(0, 999);
const BASE_RATE='BAR-' + Cypress._.random(0, 999);
...
const SHIFT_MOD_DESC='SHT-D-' + Cypress._.random(0, 999);
const TIME_SYMBOL_CODE='TS-C-' + Cypress._.random(0, 999);
const TIME_SYMBOL_DESC='TS-D-' + Cypress._.random(0, 999);
const TIME_SYMBOL_CODE1='TS-C-' + Cypress._.random(0, 999);
const TIME_SYMBOL_DESC1='TS-D-' + Cypress._.random(0, 999);
const TIME_SYMBOL_CODE2='TS-C-' + Cypress._.random(0, 999);
const TIME_SYMBOL_DESC2='TS-D-' + Cypress._.random(0, 999);
const WORKING_TI_MOD_DESC='WTMD-' + Cypress._.random(0, 999);
...
const PERIOD_CODE='PRC-' + Cypress._.random(0, 999);
const PERIOD_DESC='PRD-' + Cypress._.random(0, 999);
const CREW_CODE='CREWC-' + Cypress._.random(0, 999);

const ALLURE = Cypress.Allure.reporter.getInterface();

let PROJECT_PARAMETERS: DataCells, CONTROLLING_UNIT_MAIN_PARAMETERS_1: DataCells,CONTROLLING_UNIT_SUB_PARAMETERS_1: DataCells,ACTIONS_PARAMETERS:DataCells,CONTROLLING_UNIT_SUB_PARAMETERS_3:DataCells,CONTROLLING_UNIT_SUB_PARAMETERS_4:DataCells,CONTROLLING_UNIT_SUB_PARAMETERS_2: DataCells,EMPLOYEES_PARAMETERS:DataCells,PERIODS_PARAMETERS:DataCells,TIMEKEEPING_RESULTS_PARAMETERS2:DataCells,TIMEKEEPING_RESULTS_PARAMETERS:DataCells,WORKING_TIMES_PARAMETERS_1:DataCells,WORKING_TIMES_PARAMETERS_2:DataCells,WORKING_TIMES_PARAMETERS_3:DataCells,WORKING_TIMES_PARAMETERS_4:DataCells, CREW_RECORDING_PARAMETERS:DataCells,TIMEKEEPING_RESULTS_PARAMETERS1:DataCells,EMPLOYEES_PARAMETERS1:DataCells,ACCOUNT_ALLOCATION_RULES_PARAMETERS1:DataCells,ACCOUNT_ALLOCATION_RULES_PARAMETERS2:DataCells
let CONTAINERS_CONTROLLING_UNITS,CONTAINER_COLUMNS_CONTROLLING_UNITS,CONTAINER_COLUMNS_ACTIONS,CONTAINER_COLUMNS_PROJECT, CONTAINER_COLUMNS_WORKING_TIME_MODELS,CONTAINER_COLUMNS_WORKING_TIME_MODEL_DAYS,CONTAINER_COLUMNS_TIMEKEEPING_RESULTS,CONTAINER_COLUMNS_CREW_RECORDINGS,CONTAINER_COLUMNS_TRANSACTIONS,CONTAINERS_ACCOUNT_ALLOCATION_RULES
let CONTAINERS_ACTIONS,CONTAINERS_DATA_TYPES,CONTAINERS_PROJECT,CONTAINERS_PAYMENT_GROUP_RATES,CONTAINERS_PAYMENT_GROUP_SURCHARGE,CONTAINERS_SHIFT_MODELS,CONTAINERS_WORKING_TIMES,CONTAINERS_TIME_SYMBOLS,CONTAINERS_WORKING_TIME_MODELS,CONTAINERS_WORKING_TIME_MODEL_DAYS,CONTAINERS_EMPLOYEES,CONTAINERS_PERIODS,CONTAINERS_TIMEKEEPING_RESULTS,CONTAINERS_COMPANY,CONTAINERS_TRANSACTIONS
let PAYMENT_GROUP_PARAMETERS:DataCells,PAYMENT_GROUP_RATE_PARAMETERS:DataCells,SHIFT_MODELS_PARAMETERS:DataCells,WORKING_TIMES_PARAMETERS:DataCells,TIME_SYMBOLS_PARAMETERS1:DataCells,TIME_SYMBOLS_PARAMETERS2:DataCells,TIME_SYMBOLS_PARAMETERS:DataCells,WORKING_TIME_MODELS_PARAMETERS:DataCells,WORKING_TIME_MODEL_DAYS_PARAMETERS:DataCells,TIMEKEEPING_GROUPS_PARAMETERS:DataCells,WORKING_TIME_MODEL_DAYS_PARAMETERS_1:DataCells,WORKING_TIME_MODEL_DAYS_PARAMETERS_2:DataCells,WORKING_TIME_MODEL_DAYS_PARAMETERS_3:DataCells,WORKING_TIME_MODEL_DAYS_PARAMETERS_4:DataCells,ACCOUNT_ALLOCATION_RULES_PARAMETERS:DataCells
let CONTAINER_COLUMNS_PAYMENT_GROUPS,CONTAINER_COLUMNS_PAYMENT_GROUP_RATES,CONTAINER_COLUMNS_PAYMENT_GROUP_SURCHARGE,CONTAINER_COLUMNS_SHIFT_MODELS,CONTAINER_COLUMNS_WORKING_TIMES,CONTAINER_COLUMNS_TIME_SYMBOLS,CONTAINER_COLUMNS_ACCOUNT_ALLOCATION_RULES,CONTAINER_COLUMNS_TIMEKEEPING_GROUPS,CONTAINER_COLUMNS_EMPLOYEES,CONTAINER_COLUMNS_PERIODS

ALLURE.epic("TIME KEEPING");
ALLURE.feature("Time Keeping");
ALLURE.story("ETK- 1.39 | Generate Timekeeping result for multiple dimension and account TK-TR007");

describe("ETK- 1.39 | Generate Timekeeping result for multiple dimension and account TK-TR007", () => {

    before(function () {
        cy.fixture("time-keeping/etk-1.39-generate-timekeeping-result-for-multiple-dimension-and-account.json").then((data) => {
            this.data = data;
            ...
            TIME_SYMBOLS_PARAMETERS1={
                [app.GridCells.CODE]: TIME_SYMBOL_CODE1,
                [app.GridCells.DESCRIPTION_INFO]: TIME_SYMBOL_DESC1,
                [app.GridCells.IS_PRESENCE]: CONTAINERS_TIME_SYMBOLS.CHECKBOX,
                [app.GridCells.IS_PRODUCTIVE]: CONTAINERS_TIME_SYMBOLS.CHECKBOX,
                [app.GridCells.VALUATION_PERCENT]: CONTAINERS_TIME_SYMBOLS.VAL_PERCENTAGE,
                [app.GridCells.VALUATION_RATE]: CONTAINERS_TIME_SYMBOLS.VAL_RATE,
            ...
            TIME_SYMBOLS_PARAMETERS2={
                [app.GridCells.CODE]: TIME_SYMBOL_CODE2,
                [app.GridCells.DESCRIPTION_INFO]: TIME_SYMBOL_DESC2,
                [app.GridCells.IS_PRESENCE]: CONTAINERS_TIME_SYMBOLS.CHECKBOX,
                [app.GridCells.IS_PRODUCTIVE]: CONTAINERS_TIME_SYMBOLS.CHECKBOX,
                [app.GridCells.VALUATION_PERCENT]: CONTAINERS_TIME_SYMBOLS.VAL_PERCENTAGE,
                [app.GridCells.VALUATION_RATE]: CONTAINERS_TIME_SYMBOLS.VAL_RATE,
            ...
            CONTAINERS_ACCOUNT_ALLOCATION_RULES=this.data.CONTAINERS.ACCOUNT_ALLOCATION_RULES
            ACCOUNT_ALLOCATION_RULES_PARAMETERS={
                [app.GridCells.SURCHARGE_TYPE_FK]: BASE_RATE,
                [app.GridCells.ACCOUNT_COST_FK]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_COST[0],
                [app.GridCells.ACCOUNT_REV_FK]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_REV[0],
                [app.GridCells.NOMINAL_DIMENSION1_COST]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION1_COST[0],
                [app.GridCells.NOMINAL_DIMENSION2_COST]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION2_COST[0],
                [app.GridCells.NOMINAL_DIMENSION3_COST]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION3_COST[0],
                [app.GridCells.NOMINAL_DIMENSION1_REV]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION1_REV[0],
                [app.GridCells.NOMINAL_DIMENSION2_REV]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION2_REV[0],
                [app.GridCells.NOMINAL_DIMENSION3_REV]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION3_REV[0]    
            },
            ACCOUNT_ALLOCATION_RULES_PARAMETERS1={
                [app.GridCells.SURCHARGE_TYPE_FK]: BASE_RATE,
                [app.GridCells.ACCOUNT_COST_FK]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_COST[0],
                [app.GridCells.ACCOUNT_REV_FK]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_REV[0],
                [app.GridCells.NOMINAL_DIMENSION1_COST]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION1_COST[1],
                [app.GridCells.NOMINAL_DIMENSION2_COST]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION2_COST[1],
                [app.GridCells.NOMINAL_DIMENSION3_COST]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION3_COST[1],
                [app.GridCells.NOMINAL_DIMENSION1_REV]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION1_REV[1],
                [app.GridCells.NOMINAL_DIMENSION2_REV]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION2_REV[1],
                [app.GridCells.NOMINAL_DIMENSION3_REV]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION3_REV[1]    
            },
            ACCOUNT_ALLOCATION_RULES_PARAMETERS2={
                [app.GridCells.SURCHARGE_TYPE_FK]: BASE_RATE,
                [app.GridCells.ACCOUNT_COST_FK]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_COST[1],
                [app.GridCells.ACCOUNT_REV_FK]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_REV[1],
                [app.GridCells.NOMINAL_DIMENSION1_COST]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION1_COST[2],
                [app.GridCells.NOMINAL_DIMENSION2_COST]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION2_COST[2],
                [app.GridCells.NOMINAL_DIMENSION3_COST]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION3_COST[2],
                [app.GridCells.NOMINAL_DIMENSION1_REV]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION1_REV[2],
                [app.GridCells.NOMINAL_DIMENSION2_REV]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION2_REV[2],
                [app.GridCells.NOMINAL_DIMENSION3_REV]:CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION3_REV[2]    
            },
            ...
            TIMEKEEPING_RESULTS_PARAMETERS={
                ...
                [app.GridCells.HOURS]:CONTAINERS_TIMEKEEPING_RESULTS.HOURS[0],
            ...
            TIMEKEEPING_RESULTS_PARAMETERS1={
                [app.GridCells.PROJECT_ACTION_FK]:ACTIONS_CODE,
                [app.GridCells.HOURS]:CONTAINERS_TIMEKEEPING_RESULTS.HOURS[1],
                [app.GridCells.TIME_SYMBOL_FK]:TIME_SYMBOL_CODE1,
                [app.GridCells.RATE]:CONTAINERS_TIMEKEEPING_RESULTS.RATE,
                [app.GridCells.SHEET_FK]:EMPLOYEE_CODE
            },
            TIMEKEEPING_RESULTS_PARAMETERS2={
                [app.GridCells.PROJECT_ACTION_FK]:ACTIONS_CODE,
                [app.GridCells.HOURS]:CONTAINERS_TIMEKEEPING_RESULTS.HOURS[2],
                [app.GridCells.TIME_SYMBOL_FK]:TIME_SYMBOL_CODE2,
                [app.GridCells.RATE]:CONTAINERS_TIMEKEEPING_RESULTS.RATE,
                [app.GridCells.SHEET_FK]:EMPLOYEE_CODE
            },
    ...
    it("TC - Create Data records", function () {
        ...
        _common.waitForLoaderToDisappear()
        _common.clear_subContainerFilter(cnt.uuid.DATA_TYPES)
        _common.search_inSubContainer(cnt.uuid.DATA_TYPES,CONTAINERS_DATA_TYPES.ACCOUNTING)
        _common.select_rowHasValue_onIndexBased(cnt.uuid.DATA_TYPES,CONTAINERS_DATA_TYPES.ACCOUNTING,1)
        cy.REFRESH_CONTAINER()
        _common.waitForLoaderToDisappear()
        _common.openTab(app.TabBar.MASTERDATA).then(() => {
            _common.select_tabFromFooter(cnt.uuid.DATA_RECORDS, app.FooterTab.DATA_RECORDS, 1);
        ...
        _common.search_inSubContainer(cnt.uuid.DATA_RECORDS,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_COST[0])
        _common.waitForLoaderToDisappear()
        _common. create_newRecordIfDataNotFound(cnt.uuid.DATA_RECORDS,app.GridCells.DESCRIPTION_INFO,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_COST[0])
        _common.waitForLoaderToDisappear()
        cy.get('@CHECK_DATA')
        .then((value) => {
            if (value.toString() == "Data does not exist") {
            _common.edit_dropdownCellWithCaret(cnt.uuid.DATA_RECORDS,app.GridCells.LEDGER_CONTEXT_FK,commonLocators.CommonKeys.LIST,CONTAINERS_DATA_TYPES.RIB_DEMO)
            _common.edit_containerCell(cnt.uuid.DATA_RECORDS,app.GridCells.CODE,app.InputFields.DOMAIN_TYPE_CODE,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_COST[0])
            _common.edit_containerCell(cnt.uuid.DATA_RECORDS,app.GridCells.DESCRIPTION_INFO,app.InputFields.DOMAIN_TYPE_TRANSLATION,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_COST[0])
            _common.waitForLoaderToDisappear()
            cy.SAVE()
            _common.waitForLoaderToDisappear()
            }
        ...
        _common.waitForLoaderToDisappear()
        _common.clear_subContainerFilter(cnt.uuid.DATA_RECORDS)
        _common.search_inSubContainer(cnt.uuid.DATA_RECORDS,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_REV[0])
        _common.waitForLoaderToDisappear()
        _common. create_newRecordIfDataNotFound(cnt.uuid.DATA_RECORDS,app.GridCells.DESCRIPTION_INFO,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_REV[0])
        cy.get('@CHECK_DATA')
        .then((value) => {
            if (value.toString() == "Data does not exist") {
            _common.edit_dropdownCellWithCaret(cnt.uuid.DATA_RECORDS,app.GridCells.LEDGER_CONTEXT_FK,commonLocators.CommonKeys.LIST,CONTAINERS_DATA_TYPES.RIB_DEMO)
            _common.edit_containerCell(cnt.uuid.DATA_RECORDS,app.GridCells.CODE,app.InputFields.DOMAIN_TYPE_CODE,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_REV[0])
            _common.edit_containerCell(cnt.uuid.DATA_RECORDS,app.GridCells.DESCRIPTION_INFO,app.InputFields.DOMAIN_TYPE_TRANSLATION,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_REV[0])
            _common.waitForLoaderToDisappear()
            cy.SAVE()
            _common.waitForLoaderToDisappear()
            }
        ...
        _common.waitForLoaderToDisappear()
        _common.clear_subContainerFilter(cnt.uuid.DATA_RECORDS)
        _common.search_inSubContainer(cnt.uuid.DATA_RECORDS,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_COST[1])
        _common.waitForLoaderToDisappear()
        _common. create_newRecordIfDataNotFound(cnt.uuid.DATA_RECORDS,app.GridCells.DESCRIPTION_INFO,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_COST[1])
        _common.waitForLoaderToDisappear()
        cy.get('@CHECK_DATA')
        .then((value) => {
            if (value.toString() == "Data does not exist") {
            _common.edit_dropdownCellWithCaret(cnt.uuid.DATA_RECORDS,app.GridCells.LEDGER_CONTEXT_FK,commonLocators.CommonKeys.LIST,CONTAINERS_DATA_TYPES.RIB_DEMO)
            _common.edit_containerCell(cnt.uuid.DATA_RECORDS,app.GridCells.CODE,app.InputFields.DOMAIN_TYPE_CODE,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_COST[1])
            _common.edit_containerCell(cnt.uuid.DATA_RECORDS,app.GridCells.DESCRIPTION_INFO,app.InputFields.DOMAIN_TYPE_TRANSLATION,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_COST[1])
            _common.waitForLoaderToDisappear()
            cy.SAVE()
            _common.waitForLoaderToDisappear()
            }
        ...
        _common.waitForLoaderToDisappear()
        _common.clear_subContainerFilter(cnt.uuid.DATA_RECORDS)
        _common.search_inSubContainer(cnt.uuid.DATA_RECORDS,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_REV[1])
        _common.waitForLoaderToDisappear()
        _common. create_newRecordIfDataNotFound(cnt.uuid.DATA_RECORDS,app.GridCells.DESCRIPTION_INFO,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_REV[1])
        cy.get('@CHECK_DATA')
        .then((value) => {
            if (value.toString() == "Data does not exist") {
            _common.edit_dropdownCellWithCaret(cnt.uuid.DATA_RECORDS,app.GridCells.LEDGER_CONTEXT_FK,commonLocators.CommonKeys.LIST,CONTAINERS_DATA_TYPES.RIB_DEMO)
            _common.edit_containerCell(cnt.uuid.DATA_RECORDS,app.GridCells.CODE,app.InputFields.DOMAIN_TYPE_CODE,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_REV[1])
            _common.edit_containerCell(cnt.uuid.DATA_RECORDS,app.GridCells.DESCRIPTION_INFO,app.InputFields.DOMAIN_TYPE_TRANSLATION,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_REV[1])
            _common.waitForLoaderToDisappear()
            cy.SAVE()
            _common.waitForLoaderToDisappear()
            }
    ...
    it("TC - Create Time symbols and add Account allocations rules", function () {
       ...
       _common.maximizeContainer(cnt.uuid.ACCOUNT_ALLOCATION_RULES)
       _common.waitForLoaderToDisappear()
       ...
       cy.SAVE()
       _common.waitForLoaderToDisappear()
       _common.minimizeContainer(cnt.uuid.ACCOUNT_ALLOCATION_RULES)
       _common.waitForLoaderToDisappear()
       _common.openTab(app.TabBar.TIME_SYMBOLS).then(() => {
       _common.select_tabFromFooter(cnt.uuid.TIME_SYMBOLS, app.FooterTab.TIME_SYMBOLS);
       })
       ...
       _common.create_newRecord(cnt.uuid.ACCOUNT_ALLOCATION_RULES)
       _common.waitForLoaderToDisappear()
       _timekeepingPage.enterRecord_toAccountAllocationRules(cnt.uuid.ACCOUNT_ALLOCATION_RULES,ACCOUNT_ALLOCATION_RULES_PARAMETERS1)
       cy.SAVE()
       _common.waitForLoaderToDisappear()
       _common.minimizeContainer(cnt.uuid.ACCOUNT_ALLOCATION_RULES)
       _common.waitForLoaderToDisappear()
       ...
       _common.create_newRecord(cnt.uuid.ACCOUNT_ALLOCATION_RULES)
       _common.waitForLoaderToDisappear()
       _timekeepingPage.enterRecord_toAccountAllocationRules(cnt.uuid.ACCOUNT_ALLOCATION_RULES,ACCOUNT_ALLOCATION_RULES_PARAMETERS2)
       cy.SAVE()
       _common.waitForLoaderToDisappear()
       _common.minimizeContainer(cnt.uuid.ACCOUNT_ALLOCATION_RULES)
       _common.waitForLoaderToDisappear()
    ...
    it("TC -Create Employee sheets and 3 Timekeeping results", function () {
        _common.toggleSidebar(sidebar.sideBarList.SIDEBAR_QUICKSTART)
        ...
        _common.waitForLoaderToDisappear()
        _common.create_newRecord(cnt.uuid.TIMEKEEPING_RESULTS)
        _timekeepingPage.enterRecord_toTimekeepingResults(cnt.uuid.TIMEKEEPING_RESULTS,TIMEKEEPING_RESULTS_PARAMETERS1)
        cy.SAVE()  
        _common.waitForLoaderToDisappear()
        _common.create_newRecord(cnt.uuid.TIMEKEEPING_RESULTS)
        _timekeepingPage.enterRecord_toTimekeepingResults(cnt.uuid.TIMEKEEPING_RESULTS,TIMEKEEPING_RESULTS_PARAMETERS2)
        cy.SAVE()  
        _common.waitForLoaderToDisappear()
        _common.minimizeContainer(cnt.uuid.TIMEKEEPING_RESULTS)
        _common.waitForLoaderToDisappear()
    })
    it("TC -Verify timekeeping period transaction result for multiple dimension and account", function () {
        _common.toggleSidebar(sidebar.sideBarList.SIDEBAR_QUICKSTART)
        _common.search_fromSidebar(commonLocators.CommonKeys.QUICKSTART, sidebar.SideBarOptions.TIMEKEEPING_PERIOD)
        _common.waitForLoaderToDisappear()
        cy.wait(2000)
        ...
        _common.openTab(app.TabBar.PERIOD).then(() => {
            ...
            _common.set_containerLayoutUnderEditView(commonLocators.CommonKeys.LAYOUT_2)
            _common.waitForLoaderToDisappear()
            _common.select_tabFromFooter(cnt.uuid.TRANSACTIONS, app.FooterTab.TRANSACTIONS);
            _common.setup_gridLayout(cnt.uuid.TRANSACTIONS, CONTAINER_COLUMNS_TRANSACTIONS)
            _common.set_columnAtTop([CONTAINER_COLUMNS_TRANSACTIONS.accountfk,CONTAINER_COLUMNS_TRANSACTIONS.nominaldimension3,CONTAINER_COLUMNS_TRANSACTIONS.nominaldimension2,CONTAINER_COLUMNS_TRANSACTIONS.nominaldimension1,CONTAINER_COLUMNS_TRANSACTIONS.transactioncase,CONTAINER_COLUMNS_TRANSACTIONS.quantity,CONTAINER_COLUMNS_TRANSACTIONS.amount,CONTAINER_COLUMNS_TRANSACTIONS.controllingunitfk], cnt.uuid.TRANSACTIONS)
        })
        _common.waitForLoaderToDisappear()
        ...
        _common.waitForLoaderToDisappear()
        _common.clear_subContainerFilter(cnt.uuid.TRANSACTIONS)
        _common.search_inSubContainer(cnt.uuid.TRANSACTIONS,Cypress.env("C_UNIT1"))
        _common.waitForLoaderToDisappear()
        _common.select_rowHasValue_onIndexBased(cnt.uuid.TRANSACTIONS,Cypress.env("C_UNIT1"),0)
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.QUANTITY_SMALL,CONTAINERS_TIMEKEEPING_RESULTS.HOURS[0])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION1,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION1_COST[0])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION2,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION2_COST[0])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION3,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION3_COST[0])
        _common.waitForLoaderToDisappear()
        _common.assert_forNumericValues(cnt.uuid.TRANSACTIONS,app.GridCells.AMOUNT_SMALL,CONTAINERS_PAYMENT_GROUP_RATES.RATE)
        _common.waitForLoaderToDisappear()
        ...
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.ACCOUNT_FK,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_COST[0])
        _common.waitForLoaderToDisappear()
        _common.select_rowHasValue_onIndexBased(cnt.uuid.TRANSACTIONS,Cypress.env("C_UNIT1"),1)
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.QUANTITY_SMALL,CONTAINERS_TIMEKEEPING_RESULTS.HOURS[1])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.CONTROLLING_UNIT_FK,Cypress.env("C_UNIT1"))
        _common.waitForLoaderToDisappear()
        _common.assert_forNumericValues(cnt.uuid.TRANSACTIONS,app.GridCells.AMOUNT_SMALL,(CONTAINERS_PAYMENT_GROUP_RATES.RATE*2).toString())
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.TRANSACTION_CASE,CONTAINERS_TRANSACTIONS.TRANSACTION_CASES[0])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION1,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION1_COST[1])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION2,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION2_COST[1])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION3,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION3_COST[1])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.ACCOUNT_FK,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_COST[0])
        _common.waitForLoaderToDisappear()
        _common.select_rowHasValue_onIndexBased(cnt.uuid.TRANSACTIONS,Cypress.env("C_UNIT1"),2)
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.QUANTITY_SMALL,CONTAINERS_TIMEKEEPING_RESULTS.HOURS[2])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.CONTROLLING_UNIT_FK,Cypress.env("C_UNIT1"))
        _common.waitForLoaderToDisappear()
        _common.assert_forNumericValues(cnt.uuid.TRANSACTIONS,app.GridCells.AMOUNT_SMALL,(CONTAINERS_PAYMENT_GROUP_RATES.RATE*3).toString())
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.TRANSACTION_CASE,CONTAINERS_TRANSACTIONS.TRANSACTION_CASES[0])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION1,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION1_COST[2])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION2,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION2_COST[2])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION3,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION3_COST[2])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.ACCOUNT_FK,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_COST[1])
        _common.waitForLoaderToDisappear()
        _common.clear_subContainerFilter(cnt.uuid.TRANSACTIONS)
        _common.search_inSubContainer(cnt.uuid.TRANSACTIONS,Cypress.env("C_UNIT2"))
        _common.waitForLoaderToDisappear()
        _common.select_rowHasValue_onIndexBased(cnt.uuid.TRANSACTIONS,Cypress.env("C_UNIT2"),0)
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.QUANTITY_SMALL,CONTAINERS_TIMEKEEPING_RESULTS.HOURS[0])
        _common.waitForLoaderToDisappear()
        ...
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION1,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION1_REV[0])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION2,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION2_REV[0])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION3,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION3_REV[0])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.ACCOUNT_FK,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_REV[0])
        _common.waitForLoaderToDisappear()
        _common.select_rowHasValue_onIndexBased(cnt.uuid.TRANSACTIONS,Cypress.env("C_UNIT2"),1)
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.QUANTITY_SMALL,CONTAINERS_TIMEKEEPING_RESULTS.HOURS[1])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.CONTROLLING_UNIT_FK,Cypress.env("C_UNIT2"))
        ...
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.TRANSACTION_CASE,CONTAINERS_TRANSACTIONS.TRANSACTION_CASES[1])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION1,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION1_REV[1])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION2,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION2_REV[1])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION3,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION3_REV[1])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.ACCOUNT_FK,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_REV[0])
        _common.waitForLoaderToDisappear()
        _common.select_rowHasValue_onIndexBased(cnt.uuid.TRANSACTIONS,Cypress.env("C_UNIT2"),2)
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.QUANTITY_SMALL,CONTAINERS_TIMEKEEPING_RESULTS.HOURS[2])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.CONTROLLING_UNIT_FK,Cypress.env("C_UNIT2"))
        ...
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.TRANSACTION_CASE,CONTAINERS_TRANSACTIONS.TRANSACTION_CASES[1])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION1,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION1_REV[2])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION2,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION2_REV[2])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.NOMINAL_DIMENSION3,CONTAINERS_ACCOUNT_ALLOCATION_RULES.DIMENSION3_REV[2])
        _common.waitForLoaderToDisappear()
        _common.assert_cellData_insideActiveRow(cnt.uuid.TRANSACTIONS,app.GridCells.ACCOUNT_FK,CONTAINERS_ACCOUNT_ALLOCATION_RULES.ACCOUNT_REV[1])
        _common.waitForLoaderToDisappear()
