...
const TIME_SYMBOL_DESC_OVERTIME='T-SYB-OT-D' + Cypress._.random(0, 999);
...
let TIME_SYMBOLS_PARAMETERS:DataCells,TIME_SYMBOLS_PARAMETERS1:DataCells
...
ALLURE.story("ETK- 1.23 | Calculate overtime for the employee");

describe("ETK- 1.23 | Calculate overtime for the employee", () => {

    before(function () {
        cy.fixture("time-keeping/etk-1.23-calculate-overtime-for-the-employee.json").then((data) => {
            this.data = data;
            ...
            EMPLOYEES_PARAMETERS={
                ...
                [app.GridCells.GENERATE_RECORDING]:commonLocators.CommonKeys.CHECK,
                [app.GridCells.IS_CREW_LEADER]:commonLocators.CommonKeys.CHECK
            },
    ...
    it("TC -Calculate overtime and verify overtime record generated ", function () {
        ...
        _common.clear_subContainerFilter(cnt.uuid.EMPLOYEE_REPORT)
        _common.clickOn_cellHasValue(cnt.uuid.EMPLOYEE_REPORT,app.GridCells.TIME_SYMBOL_FK,TIME_SYMBOL_CODE_OVERTIME)
    })
})
