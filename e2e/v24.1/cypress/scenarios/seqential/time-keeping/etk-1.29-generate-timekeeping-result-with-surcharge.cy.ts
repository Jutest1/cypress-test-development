...
ALLURE.story("ETK- 1.29 | Generate Timekeeping result with Surcharge TK-TR002");

describe("ETK- 1.29 | Generate Timekeeping result with Surcharge TK-TR002", () => {

    before(function () {
        cy.fixture("time-keeping/etk-1.29-generate-timekeeping-result-with-surcharge.json").then((data) => {
            this.data = data;
